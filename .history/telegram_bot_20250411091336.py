...
summarization is now done synchronously (per the provided guide) and the 
circular import issue has been resolved by moving shared functions.
"""
...
# Note: We removed 'save_message_to_history' from telegram_bot to break the circular dependency.
...
# Instead, import shared history functions from db_manager (which already contains save_message_to_history and save_session_id)
from db_manager import save_message_to_history, save_session_id
...
# (Callback handlers for inline buttons are omitted for brevity.)
