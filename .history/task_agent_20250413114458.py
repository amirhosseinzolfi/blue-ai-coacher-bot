...
from langgraph.checkpoint.sqlite import SqliteSaver  # Updated import path for SqliteSaver
...
print(f"Graph built and compiled with SQLite checkpointer ({CHECKPOINT_DB}).")
    ...
    while True:
        ...
        try:
            ...
            if final_state_value and final_state_value.get('messages'):
                ...
                assistant_response = "Sorry, something went wrong during processing."
