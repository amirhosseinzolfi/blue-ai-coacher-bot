...
class DatabaseManager:
    ...
    def create_new_session(self, chat_id: str, chat_type: str = "private") -> str:
        """Create a new chat session and return the session ID."""
        session_id = f"{chat_id}_{int(datetime.datetime.utcnow().timestamp())}"
        ...
        # Create a fresh summary document for the new session
        self.chat_summaries.insert_one({
            "chat_id": chat_id,
            "chat_type": chat_type,
            "session_id": session_id,
            "summary": "",
    ...
    def get_current_session_id(self, chat_id: str, chat_type: str = "private") -> Optional[str]:
    ...
    def get_session_summary(self, chat_id: str, session_id: str) -> str:
        """Get the conversation summary for a specific session."""
        doc = self.chat_summaries.find_one({
            "chat_id": chat_id,
            "session_id": session_id
        })
        return doc.get("summary", "") if doc else ""

    def save_session_summary(self, chat_id: str, session_id: str, summary: str) -> None:
        """Save the conversation summary for a specific session."""
...
def create_new_chat_session(chat_id: str, chat_type: str = "private") -> str:
    return _db_manager.create_new_session(chat_id, chat_type)

def get_current_session(chat_id: str, chat_type: str = "private") -> str:
    return _db_manager.get_current_session_id(chat_id, chat_type)
