...
def new_chat(message):
    ...
    This command resets user report, clears chat history,
    ...
    # Import save_business_info from db_manager to clear the user report.
    from db_manager import save_business_info

    # Clear user report by saving an empty string.
    ...
    response_text = "🆕 جلسه چت جدید ایجاد شد. جلسه قبلی ذخیره شده و تاریخچه چت و گزارش کاربر بازیابی/پاکسازی شدند."
