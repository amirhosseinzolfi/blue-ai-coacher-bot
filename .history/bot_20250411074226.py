...
from config import (
    ...
    DATABASE_NAME,
    COLLECTION_NAME
    # BUSINESS_INFO_COLLECTION is no longer needed here
)
...
def new_chat(message):
    ...
    # Use chat_id_str for save_message_to_history as it expects string for Langchain history
...
def cleanup():
    ...
    # Import the specific close function from db_manager
    from db_manager import close_db_connection
    close_db_connection() # Call the function to close MongoDB connection
    cleanup_sessions() # Close aiohttp sessions
