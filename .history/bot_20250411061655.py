...
def new_chat(message):
    ...
    # Import and use the centralized session functions from telegram_bot
    from telegram_bot import save_session_id
    from db_manager import save_user_info
    save_user_info(chat_id, "")
    save_session_id(chat_id, new_session_id)
    logger.info(f"New chat session created for chat '{chat_id}': {new_session_id} (Chat history reset, user report refreshed)")
