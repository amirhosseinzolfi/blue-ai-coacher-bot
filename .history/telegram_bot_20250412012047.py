...
def optimize_memory(state: Dict[str, Any]) -> Dict[str, Any]:
    ...
    current_state = {
        ...
        "last_summary_time": state.get("last_summary_time", time.time()),
    ...
    if current_state["summary"]:
        ...
        new_messages = messages[summary_idx + 1:]
    else:
    ...
    summary_text = generate_summary(new_messages, current_state["summary"])
    ...
    current_state["messages"] = [new_system] + recent_messages
    current_state["summary"] = summary_text
    current_state["last_summary_time"] = time.time()
