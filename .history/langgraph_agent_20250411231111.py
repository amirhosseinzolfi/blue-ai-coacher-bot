...
# Add custom checkpointer class
class MongoCheckpointer:
    """Custom MongoDB checkpointer that implements the required interface."""
    ...
    def get_next_version(self, task_path=None):
        """Get next version for checkpoint."""
    ...
    def put_writes(self, writes, version, task_path=None):
