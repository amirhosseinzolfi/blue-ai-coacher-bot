...
def send_welcome(message):
    ...
    save_message_to_history(chat_id, "system", welcome_message, chat_type=chat_type)
...
def send_help(message):
    ...
    save_message_to_history(chat_id, "system", help_text_prompt, chat_type=chat_type)
...
def about_bot(message):
    ...
    save_message_to_history(chat_id, "system", about_text, chat_type=chat_type)
