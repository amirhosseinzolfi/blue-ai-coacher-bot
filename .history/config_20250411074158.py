...
COLLECTION_NAME = 'chat_history' # Used by Langchain history saver
# BUSINESS_INFO_COLLECTION is now defined within db_manager.py

############################################
# State Management (In-Memory Flags/Preferences)
############################################
# Chat session management - No longer needed, session ID stored in DB via db_manager
# chat_session_map = {}

# Business info management - Keep flags for update process state
# business_info_map = {} # Replaced by db_manager storage
...
__all__ = [
    ...
    'DATABASE_NAME',
    'COLLECTION_NAME', # Keep for Langchain history saver
    # 'BUSINESS_INFO_COLLECTION', # Remove
    # 'chat_session_map', # Remove
    # 'business_info_map', # Remove
    'business_info_update_pending', # Keep
    'business_info_mode', # Keep
    'ai_tone_map',
