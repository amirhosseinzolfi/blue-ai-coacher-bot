...
SUMMARY_PROMPT_TEXT = """Summarize the conversation by extracting only the most essential business and task-related information. Include ONLY:
- Core questions/requests directly related to users' tasks and business operations (e.g., in/out hours, journal entries).
- Essential details on business activities, projects, and work schedules.

Eliminate all pleasantries, explanations, and non-critical details. Use minimal sentence fragments where possible.
