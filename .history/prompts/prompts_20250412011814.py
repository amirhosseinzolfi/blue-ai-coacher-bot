...
SUMMARY_PROMPT_TEXT = """لطفاً گفتگوی جدید زیر را با تمرکز بر موارد مهم خلاصه کنید. خلاصه باید موارد زیر را شامل شود:

1. درخواست‌ها و وظایف اصلی کاربر 📋
2. تصمیمات و توافقات مهم 🤝
3. نیازها و اولویت‌های کسب‌وکار 💼
