...
class DatabaseManager:
    ...
    def save_chat_session(self, chat_id: str, chat_type: str, session_id: str) -> None:
        # Save the session permanently for the chat (private or group)
    ...
    def get_chat_session(self, chat_id: str, chat_type: str) -> Optional[str]:
        # Retrieve the session permanently stored for the chat
...
def save_message_to_history(chat_id: str, role: str, content: str, session_id: Optional[str] = None, chat_type: str = "private") -> None:
    _db_manager.save_chat_message(chat_id, role, content, session_id or f"{chat_id}_default", chat_type)
...
__all__ = [
    ...
    'get_chat_history',
    'db_manager',
    'save_chat_session',      # New export
    'get_chat_session'        # New export
]
