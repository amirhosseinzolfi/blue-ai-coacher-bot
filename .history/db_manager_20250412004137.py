...
def save_message_to_history(chat_id: str, role: str, content: str, 
                            session_id: Optional[str] = None, chat_type: str = "private") -> None:
    _db_manager.save_chat_message(chat_id, role, content, session_id or f"{chat_id}_default", chat_type)

def get_chat_history(chat_id: str, limit: int = 50, chat_type: str = "private") -> List[Dict]:
    return _db_manager.get_chat_history(chat_id, chat_type, limit=limit)
