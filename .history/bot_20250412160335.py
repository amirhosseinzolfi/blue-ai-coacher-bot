...
def new_chat(message):
    ...
    This command starts a new session while preserving all persistent business info for the chat.
    """
    ...
    # Note: Do not clear or update the persistent business info.
    # (If you had code to reset user report within business info, remove it.)

    # Create a new chat session.
    new_session_id = new_chat_session(chat_id_str)
    logger.info(f"New chat session created for chat '{int_chat_id}': {new_session_id}. Persistent business info remains unchanged.")
