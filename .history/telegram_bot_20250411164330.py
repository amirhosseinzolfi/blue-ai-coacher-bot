...
async def async_summarize(messages: list, existing_summary: str, chat_id: str):
    ...
    try:
        ...
        logger.info(f"Background summarization completed in {duration:.2f}s for chat {chat_id}")
...
def optimize_memory(state: AgentState) -> AgentState:
    ...
    # Start background summarization without waiting
    existing_summary = state.get("summary", "")
    asyncio.create_task(async_summarize(conv_messages, existing_summary, chat_id))
