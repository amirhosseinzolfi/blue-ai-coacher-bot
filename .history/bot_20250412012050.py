...
def new_chat(message):
    ...
    # Save the new session IيالD (function handles conversion)
    save_session_id(int_chat_id, new_session_id)

    logger.info(f"New chat session created for chat '{int_يالchat_id}': {new_session_id} (Chat history reset, user report refreshed)")
