...
def optimize_memory(state: AgentState) -> AgentState:
    """
    Always summarize conversation and trim to summary plus the last 2 messages.
    """
    conv_messages = [msg for msg in state["messages"] if isinstance(msg, (HumanMessage, AIMessage))]
    # Always generate summary, even if there are few messages
...
def agent(state: AgentState):
    ...
    try:
        ...
        # Instead of triggering background summarization, call optimize_memory synchronously:
