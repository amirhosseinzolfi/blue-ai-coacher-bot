...
def handle_message(message):
    ...
    try:
        ...
        # Save message to history and trigger background optimization
        save_message_to_history(chat_id, "assistant", refined_response)
        threading.Thread(
            target=background_optimize_memory,
            args=({
                "messages": get_history_for_chat(chat_id).messages,
                "chat_id": chat_id,
                "username": sender_first_name
            },),
            daemon=True
        ).start()
