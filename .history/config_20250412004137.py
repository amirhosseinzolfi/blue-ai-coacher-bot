...
############################################
# All maps are now backed by MongoDB. Data such as business info, conversation history,
# session IDs and summaries are stored permanently per unique Telegram id (private or group).
# The bot NEVER clears or removes these records automatically.
